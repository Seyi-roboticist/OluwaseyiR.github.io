...
public:
    ...
    // newly added
    static double normalizedAngleDiff(double angle1, double angle2);
    static double cost(const std::vector<double>& v1, const std::vector<double>& v2);
    static double heuristic(const std::vector<double>& v1, const std::vector<double>& v2);
    ...
    */
    vertex sample_nearby( const vertex& q, const ASBRContext::vertex& q_goal );
